...
export class TwitchEvents {
    ...
    /**
     * Creates a new TwitchEvents instance from a string or object.
     */
    static createFrom($$source: any = {}): TwitchEvents {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new TwitchEvents($$parsedSource as Partial<TwitchEvents>);
    }
}
